    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/products/seller").hasAuthority("ROLE_USER")
                        .requestMatchers(HttpMethod.GET, "/api/products/**").permitAll()
                        .requestMatchers("/api/categories/**").permitAll()
                        .requestMatchers("/uploads/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/products/**").hasAuthority("ROLE_USER")
                        .requestMatchers(HttpMethod.PATCH, "/api/products/**").hasAuthority("ROLE_USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/products/**").hasAuthority("ROLE_USER")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/admin/products").hasAuthority("ROLE_SUPER_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/claims/admin").hasAnyAuthority("ROLE_SUPER_ADMIN", "ROLE_CS_ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/claims/*/status").hasAnyAuthority("ROLE_SUPER_ADMIN", "ROLE_CS_ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/claims/*/reject").hasAnyAuthority("ROLE_SUPER_ADMIN", "ROLE_CS_ADMIN")
